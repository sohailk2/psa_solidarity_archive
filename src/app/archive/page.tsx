...
export default async function Archive() {    
    const response = await fetch('https://psa-solidarity-archive.vercel.app/api/archive/', {method: 'POST', next: { revalidate: 60 }})
    // const response = await fetch('http://localhost:3000/api/archive', {next: { revalidate: 10 }})
